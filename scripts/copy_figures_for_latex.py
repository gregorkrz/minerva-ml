...
stable names for LaTeX. Multi-page classification eval PDFs can be reduced to a
selected page.
...
CLASSIFICATION_FIRST_PAGE = [
    ("classification_eval/eval_cc1pi_tagging_1A.pdf", "CC1PiPMTagging.pdf"),
    ("classification_eval/eval_cc1pi0_tagging_1A.pdf", "CC1Pi0Tagging.pdf"),
    ("classification_eval/eval_Npi_tagging_1A.pdf", "CCNPiPMTagging.pdf"),
]

CLASSIFICATION_DETAILED_PAGES = [
    # page numbers are 1-based
    ("classification_eval/eval_cc1pi_tagging_1A.pdf", "CC1PiPM_E.pdf", 3),
    ("classification_eval/eval_cc1pi_tagging_1A.pdf", "CC1PiPM_Theta.pdf", 4),
    ("classification_eval/eval_cc1pi0_tagging_1A.pdf", "CC1Pi0_E.pdf", 2),
    ("classification_eval/eval_cc1pi0_tagging_1A.pdf", "CC1Pi0_Theta.pdf", 3),
    ("classification_eval/eval_Npi_tagging_1A.pdf", "CCNPiPM_q3.pdf", 3),
]
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Directory containing regression_eval_1/ and classification_eval/",
    )
    parser.add_argument(
        "--figures-root",
        type=Path,
    ...
    print(f"Source eval root: {out_root}")
