...
python -m src.scripts.preprocess_dataset --output-dir $DATA_DIR/Minerva/20260201_all_max_blobs_and_prongs --max-workers 1 --max-workers-per-playlist 10 --use-max-blobs-and-prongs --playlists  1B  1C  1D  1E  1F  1G  1L  1M  1N  1O  1P 
python -m src.scripts.split_dataset --input-dir $DATA_DIR/Minerva/20260201_all_max_blobs_and_prongs --output-dir $DATA_DIR/Minerva/20260201_all_max_blobs_and_prongs_split_fix_anomalies
...
python -m src.scripts.split_dataset --input-dir $DATA_DIR/Minerva/20260201_all_max_blobs_and_prongs --output-dir $DATA_DIR/Minerva/20260201_all_max_blobs_and_prongs_split_fix_anomalies --only-save-result
