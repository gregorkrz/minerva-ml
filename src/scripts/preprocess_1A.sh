...
python -m src.scripts.preprocess_dataset --output-dir $DATA_DIR/Minerva/20260216_additional_info --max-workers 1 --max-workers-per-playlist 10 --playlists 1A --use-max-blobs-and-prongs
python -m src.scripts.split_dataset --input-dir $DATA_DIR/Minerva/20260213v2 --output-dir $DATA_DIR/Minerva/20260213v2_split --playlist 1A
python -m src.scripts.compute_enu_baselines --input-dir /pscratch/sd/g/gregork/MINERvA/raw_data/MediumEnergy_FHC_StandardMC_Playlist --output-dir $DATA_DIR/Minerva/20260216_additional_info/baselines --playlist 1A
